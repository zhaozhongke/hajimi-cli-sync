...
export const CLI_LIST: CliInfo[] = [
  ...
  { id: "hermes", name: "Hermes", icon: "brain", color: "border-emerald-400", installType: "manual", category: "agent", downloadUrl: "https://hermes-agent.nousresearch.com/docs/user-guide/configuration", descKey: "toolDesc.hermes", postSyncHintKey: "toolHint.hermes", communityUrl: "https://hermes-agent.nousresearch.com/docs/user-guide/configuration" },
  ...
  { id: "qclaw", name: "QClaw", icon: "shell", color: "border-fuchsia-400", installType: "manual-config", category: "agent", downloadUrl: "https://qclaw.qq.com/QClaw", descKey: "toolDesc.qclaw", communityUrl: "https://cloud.tencent.com/document/product/1823/131063", launchName: "QClaw" },
